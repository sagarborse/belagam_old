...
?>
<?php if( $class =="boxed") { ?>
<div class="layerslider-wrapper hidden-phone" style="max-width:<?php echo $sliderParams['width'];?>px;">
<?php } ?>
			<div class="bannercontainer hidden-phone banner-<?php echo trim($class);?>" style="padding: <?php echo $sliderParams['padding'];?>;margin: <?php echo $sliderParams['margin'];?>;">
