...
<!DOCTYPE html>
<!-- OMFramework v1.7.2 Lite www.omframework.com -->
	...
	<body>
		<div id="container">
			...
			<?php if ((strrpos($route, "checkout") === false) &&
					...
					<li><a href="#search" tabindex="3" id="search_link" data-no-instant><?php echo $text_search_link; ?></a></li>
			<?php } else { ?>
					<li><a href="index.php?route=product/search_mobile" tabindex="3" id="search_link"><?php echo $text_search_link; ?></a></li>
				</ul>
			<?php } ?>
			</header>
			</header>
