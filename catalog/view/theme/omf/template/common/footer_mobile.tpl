			<footer>
				<?php if ((strrpos($route, "checkout") === false) &&
							   (strrpos($route, "account") === false) && (strrpos($route, "search") === false)) { ?>
				...
				<nav id="primary">
					<ul class="nav">
						...
						<li><a class="n-info"><?php echo $text_information; ?></a>
						...
						<li><a href="<?php echo $account; ?>" class="n-account" data-no-instant><?php echo $text_account; ?></a>
							<ul>
								<li><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
								<li><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li>
							</ul>
						</li>
						<li><a href="<?php echo $contact; ?>" class="n-contact" data-no-instant><?php echo $text_contact; ?></a>
							<ul>
...
<?php } ?>
				...
				<ul class="tools">
					...
					<li><?php echo $text_view; ?> <?php echo $text_mobile; ?> / <a href="<?php if (strpos($_SERVER['QUERY_STRING'], 'view=mobile') === false) {
								...
								} ?>" data-no-instant><?php echo $text_standard; ?></a></li>
				</ul>
<p style="text-align:center; font-size: smaller; padding-top: 2em">Powered by <a href="http://omframework.com/upgrade-lite?src=mobft" rel="nofollow">OMFramework Lite. Upgrade to unlock full functionality.</a></p>			</footer>
		</div>
		...
		<?php // --- BASIC --------------------------------------------------- ?>
		<?php if (file_exists(DIR_TEMPLATE . $this->config->get('config_mobile_theme') . '/js/instantclick.min.js')) { ?>
		<script src="<?php echo 'catalog/view/theme/' . $this->config->get('config_mobile_theme') ?>/js/instantclick.min.js" data-no-instant></script>
		<?php } else { ?>
		<script src="catalog/view/theme/omf/js/instantclick.min.js" data-no-instant></script>
		<?php } ?>
		<?php if (file_exists(DIR_TEMPLATE . $this->config->get('config_mobile_theme') . '/js/script_ic.js')) { ?>
		<script type="text/javascript"  src="<?php echo 'catalog/view/theme/' . $this->config->get('config_mobile_theme') ?>/js/script_ic.js"></script>
		<?php } else {?>
		<script type="text/javascript" src="catalog/view/theme/omf/js/script_ic.js"></script>
		<?php } ?>
		<?php // --- /BASIC --------------------------------------------------- ?>
		<?php // --- BASIC --------------------------------------------------- ?>
